...
const SubYear: React.FC<SubsYearProps> = ({
  iconLink,
  plan,
  price,
  selected,
  ...
  return (
    ...
    >
      ...
      <span className="text-coolGray text-[11px]">${price}/yr</span>
      <span className="text-marineBlue text-[11px] font-semibold">
        2 months free
      </span>
    </div>
  );
